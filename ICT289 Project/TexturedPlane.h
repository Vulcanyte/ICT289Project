...
// Excluding this guard will cause an error when multiple #includes for this header exist in a single program.
    ...
    **/
    ...
    /** @brief: Draws the texture on the model.
        ...
        @param: plane (TexturedPlane*) - The relevant TexturedPlane object.
        @param: corner (int) - The corner being colored.
        @param: r (float) - The r component of the relevant corner color.
        @param: g (float) - The g component of the relevant corner color.
        @param: b (float) - The b component of the relevant corner color.
